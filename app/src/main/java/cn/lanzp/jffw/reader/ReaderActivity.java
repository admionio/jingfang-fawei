...
public class ReaderActivity extends AppCompatActivity {
    ...
    private void loadData(String chapterTitle) {
        ...
        String volume = chapter != null ? chapter.getVolume() : "伤寒发微";
    ...
    private void renderContent() {
        ...
        int annotationColorInt = isNightMode ? getColor(R.color.nightTextTranslation) : getColor(R.color.textTranslation);
        ...
        String annotationColorHex = colorToHex(annotationColorInt);
        ...
        // Use new ArticleHtmlBuilder (no pinyin, annotation-based)
        String html = ArticleHtmlBuilder.buildFullArticleHtml(
